...
export const BoiseRulesRowSchema = z.object({
  // Send Institution
  SendInstitution: z.string(),
  SendInstitutionCity: z.string(),
  SendInstitutionState: z.string(),
  SendInstitutionCountry: z.string(),
  SendInstitutionIPEDSID: z.string(),
  SendEditionLowYear: z.string(),
  SendEditionHighYear: z.string(),

  // Send Courses (1-10)
  SendCourse1CourseCode: z.string(),
  SendCourse1CourseTitle: z.string(),
  SendCourse1Units: z.string(),
  SendCourse2CourseCode: z.string(),
  SendCourse2CourseTitle: z.string(),
  SendCourse2Units: z.string(),
  SendCourse3CourseCode: z.string(),
  SendCourse3CourseTitle: z.string(),
  SendCourse3Units: z.string(),
  SendCourse4CourseCode: z.string(),
  SendCourse4CourseTitle: z.string(),
  SendCourse4Units: z.string(),
  SendCourse5CourseCode: z.string(),
  SendCourse5CourseTitle: z.string(),
  SendCourse5Units: z.string(),
  SendCourse6CourseCode: z.string(),
  SendCourse6CourseTitle: z.string(),
  SendCourse6Units: z.string(),
  SendCourse7CourseCode: z.string(),
  SendCourse7CourseTitle: z.string(),
  SendCourse7Units: z.string(),
  SendCourse8CourseCode: z.string(),
  SendCourse8CourseTitle: z.string(),
  SendCourse8Units: z.string(),
  SendCourse9CourseCode: z.string(),
  SendCourse9CourseTitle: z.string(),
  SendCourse9Units: z.string(),
  SendCourse10CourseCode: z.string(),
  SendCourse10CourseTitle: z.string(),
  SendCourse10Units: z.string(),

  // Receive Institution
  ReceiveInstitution: z.string(),
  ReceiveEditionLowYear: z.string(),
  ReceiveEditionHighYear: z.string(),

  // Receive Courses (1-4)
  ReceiveCourse1CourseCode: z.string(),
  ReceiveCourse1CourseTitle: z.string(),
  ReceiveCourse1Units: z.string(),
  ReceiveCourse2CourseCode: z.string(),
  ReceiveCourse2CourseTitle: z.string(),
  ReceiveCourse2Units: z.string(),
  ReceiveCourse3CourseCode: z.string(),
  ReceiveCourse3CourseTitle: z.string(),
  ReceiveCourse3Units: z.string(),
  ReceiveCourse4CourseCode: z.string(),
  ReceiveCourse4CourseTitle: z.string(),
  ReceiveCourse4Units: z.string(),
});
