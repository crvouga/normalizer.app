 ...
 * @param logger - An injected logger instance from logger.ts
 * @param options - Optional: { outputDir?: string }
 */
export function generateSparklesSvg(logger: Logger, options?: { outputDir?: string }) {
...
`;
  ...
  try {
    ...
    const outputPath = path.join(outputDir, 'sparkles.svg');
