...
import { Combobox, type ComboboxFetchOptions, type ComboboxFetchResult, type ComboboxOption } from '~/src/ui/combobox';
...
export const ArtifactInput = (props: ArtifactInputProps) => {
  ...
  const fetchArtifacts = React.useCallback(
    async ({ query, page, pageSize, signal }: ComboboxFetchOptions): Promise<ComboboxFetchResult<ArtifactId>> => {
      // Simulate API delay
