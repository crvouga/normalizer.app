...
import { NormalizationRunId } from '~/src/workspace/normalization-run-id';
import { WorkspaceEventDb } from '~/src/workspace/workspace-event/workspace-event-db';
import { WorkspaceEventId } from '~/src/workspace/workspace-event/workspace-event-id';
import { WorkspaceId } from '~/src/workspace/workspace-id';
import { WorkspaceProjectionDb } from '~/src/workspace/workspace-projection/workspace-projection-db';
import type { WorkspaceProjectionEntry } from '~/src/workspace/workspace-projection/workspace-projection-entry';
...
describe.if(isOpenAIEnabled() && false)('NormalizationTask', async () => {
  ...
  test(
    ...
    async () => {
      ...
      const eventDb = new WorkspaceEventDb(db, logger);
